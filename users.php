...
requireLogin();
requireRole('administrator'); // Solo administradores pueden acceder
    ...
    <form action="users.php" method="GET" class="flex flex-wrap gap-4">
      ...
      <div class="w-full sm:w-auto">
        ...
        <select id="role" name="role"
          ...
          <option value="all" <?php echo $role === 'all' || $role === '' ? 'selected' : ''; ?>>Todos</option>
          <option value="user" <?php echo $role === 'user' ? 'selected' : ''; ?>>Usuario</option>
          <option value="support" <?php echo $role === 'support' ? 'selected' : ''; ?>>Soporte</option>
          <option value="administrator" <?php echo $role === 'administrator' ? 'selected' : ''; ?>>Administrador</option>
        </select>
      </div>
...
<div id="user-modal" class="modal">
  <div class="modal-content max-w-md w-full">
    <div class="flex justify-between items-center mb-4">
      <h2 class="text-xl font-bold" id="modal-title">Nuevo Usuario</h2>
    ...
    <form id="user-form" action="users.php" method="POST">
      ...
      <div class="mb-4">
        ...
        <input type="password" id="password" name="password" required
          class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
        <p class="text-xs text-gray-500 mt-1" id="password-hint">La contraseña debe tener al menos 8 caracteres.</p>
      </div>
...
<div id="confirm-modal" class="modal">
  <div class="modal-content max-w-md w-full">
    ...
    <p class="mb-6">¿Estás seguro de que deseas eliminar al usuario <span id="user-name-confirm" class="font-semibold"></span>? Esta acción no se puede deshacer.</p>
